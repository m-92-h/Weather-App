...
import { getWeatherDetailsCards } from "../../hooks/weatherDetailsData";
import { stateMessages } from "../../hooks/stateMessagesData";
...
export default function CurrentWeather() {
    ...
    if (error) {
        return <StateMessage message={stateMessages.error.message} />;
    }

    if (!weather) {
        return <StateMessage message={stateMessages.empty.message} />;
    }
